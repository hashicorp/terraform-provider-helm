...
func OCIRegistryLogin(ctx context.Context, meta *Meta, actionConfig *action.Configuration, registryClient *registry.Client, repository, chartName, username, password, caFile, certFile, keyFile string) diag.Diagnostics {
	...
	if username != "" && password != "" {
		err := OCIRegistryPerformLogin(ctx, meta, registryClient, ociURL, username, password, caFile, certFile, keyFile)
		if err != nil {
			diags.AddError(
				"OCI Registry Login Failed",
...
func OCIRegistryPerformLogin(ctx context.Context, meta *Meta, registryClient *registry.Client, ociURL, username, password, caFile, certFile, keyFile string) error {
